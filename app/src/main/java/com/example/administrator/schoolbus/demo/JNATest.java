...
import jna.HCNetSDKByJNA.NET_DVR_ALARMER;
...
public class JNATest {
	...
	public void Test_Login_V40()
	{
		...
		System.arraycopy("192.168.0.67".getBytes(), 0, loginInfo.sDeviceAddress, 0, "192.168.0.67".length());
		System.arraycopy("admin".getBytes(), 0, loginInfo.sUserName, 0, "admin".length());
		System.arraycopy("cg5308176".getBytes(), 0, loginInfo.sPassword, 0, "cg5308176".length());
